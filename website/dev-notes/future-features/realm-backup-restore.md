...
- Master-DB `cocoar_auth` mit `mt_tenant_databases`-Einträgen
- Pro Realm eine Tenant-DB `cocoar_auth_<slug>`
...
- Output: `/path/to/dir/cocoar-auth-backup-<timestamp>/`
...
- Cocoar.Auth muss nur dokumentieren: „pro Tenant-DB ist
