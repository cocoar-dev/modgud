...
<template>
  <ModalLayout :close="close" :title="modalTitle" :sub-title="modalSubtitle" icon="app-window"
    ...
    <div v-else class="modal-body">
      ...
      <Notice v-if="newSecret" variant="warning" class="secret-banner">
      ...
      <Notice v-if="isCreate && createBlockers.length" variant="info" class="secret-banner">
      ...
      <Notice v-if="error" variant="error" class="secret-banner">
        {{ error }}
      </Notice>
      ...
      <div class="two-col">
        ...
        <section class="col-tabs">
          ...
          <div v-show="activeTab === 'grants'" class="tab-content">
            ...
            <Notice truncate v-if="nativeGrantsEnabled" variant="info">
            ...
            <Notice truncate v-if="hasNativeGrantWithRealmOff" variant="warning">
