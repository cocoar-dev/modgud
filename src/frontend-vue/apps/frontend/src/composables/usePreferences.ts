...
const darkMode = ref(localStorage.getItem('coar-theme') === 'dark')
...
export function usePreferences() {
  ...
  function toggleDarkMode() {
    ...
    localStorage.setItem('coar-theme', darkMode.value ? 'dark' : 'light')
    applyDarkMode()
  }

  function setDarkMode(value: boolean) {
    darkMode.value = value
    localStorage.setItem('coar-theme', value ? 'dark' : 'light')
    applyDarkMode()
  }
