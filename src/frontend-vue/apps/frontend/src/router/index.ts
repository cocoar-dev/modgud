  ...
  routes: [
    ...
    // ── Authenticated area (single layout) ─────────────────────
    {
      ...
      children: [
        ...
        { path: 'admin/groups', component: () => import('@/views/admin/groups/GroupListView.vue'), meta: { requiresAdmin: true } },
        { path: 'admin/groups/create', component: () => import('@/views/admin/groups/GroupFormView.vue'), meta: { requiresAdmin: true } },
        { path: 'admin/groups/:id', component: () => import('@/views/admin/groups/GroupFormView.vue'), meta: { requiresAdmin: true } },
