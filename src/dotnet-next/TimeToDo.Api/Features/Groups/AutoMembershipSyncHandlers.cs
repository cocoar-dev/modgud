...
namespace TimeToDo.Api.Features.Groups;
...
{
    private const string PersonPrefix = nameof(TimeToDo.Authorization.Principals.Person) + ".";
    private const string GroupPrefix = nameof(TimeToDo.Authorization.Principals.Group) + ".";
