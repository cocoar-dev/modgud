...
public static class AdminChangeRequestEndpoints
{
        ...
        string payloadJson, ApplicationUser user, IMessageBus bus)
    {
        ...
        var command = new UpdateUserCommand(
            ...
            Lastname: p.Lastname,
            Acronym: p.Acronym.HasValue ? new Cocoar.Auth.Domain.Common.Optional<string>(p.Acronym.Value ?? "") : default,
            Email: p.Email.HasValue ? new Cocoar.Auth.Domain.Common.Optional<string>(p.Email.Value ?? "") : default,
            UserName: default);
