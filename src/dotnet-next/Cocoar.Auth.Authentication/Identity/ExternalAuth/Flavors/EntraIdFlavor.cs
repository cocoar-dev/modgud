...
namespace Cocoar.Auth.Authentication.Identity.ExternalAuth.Flavors;
...
/// </para>
/// </summary>
public class EntraIdFlavor : IIdentityProviderFlavor
{
    public string Key => IdpFlavor.EntraId;
    ...
    public string DefaultUserUpdateScript => """
        // Entra ID → Cocoar.Auth user patch. Returned object updates Firstname/
