...
public static class PasskeyEndpoints
{
    ...
    public static WebApplication MapPasskeyEndpoints(this WebApplication application, string path)
    {
            ...
            PasskeyLoginOptionsRequest? request) =>
        {
            ...
            context.Response.Cookies.Append("TimeToDo.Passkey.Challenge",
            ...
            JsonElement body) =>
        {
            ...
            var challengeCookie = context.Request.Cookies["TimeToDo.Passkey.Challenge"];
            ...
            context.Response.Cookies.Delete("TimeToDo.Passkey.Challenge");
