...
///
///   docker exec &lt;container&gt; dotnet TimeToDo.Api.dll recover list
///   docker exec &lt;container&gt; dotnet TimeToDo.Api.dll recover reset-2fa &lt;username&gt;
///   docker exec &lt;container&gt; dotnet TimeToDo.Api.dll recover magic-link &lt;username&gt;
///   docker exec &lt;container&gt; dotnet TimeToDo.Api.dll recover help
///
...
public static class RecoveryCli
{
        ...
        string[] args)
    {
        ...
        var personConflict = await session.Query<TimeToDo.Authorization.Principals.Person>()
    ...
    private static async Task<int> RebuildProjectionsAsync(IServiceProvider services)
    {
        ...
        await daemon.RebuildProjectionAsync<TimeToDoPrincipalProjection>(timeout, CancellationToken.None);
        Console.WriteLine("  OK TimeToDoPrincipalProjection (mt_doc_principal)");
