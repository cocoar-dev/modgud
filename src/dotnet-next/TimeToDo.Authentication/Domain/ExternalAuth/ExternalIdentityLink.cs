...
/// <summary>
/// A proven association between a TimeToDo user and an external identity asserted
/// by an IdP. Unique by <c>(Issuer, Subject)</c> globally — the same external
/// identity cannot map to two TimeToDo users.
/// <para>
...
public class ExternalIdentityLink
{
    ...
    /// <summary>The TimeToDo user this link belongs to.</summary>
