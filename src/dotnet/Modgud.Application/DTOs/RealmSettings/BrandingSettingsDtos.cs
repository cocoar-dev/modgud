...
/// <summary>Patch payload for the Branding sub-section. Tri-state per
/// field: missing/<c>null</c> = no change, <c>""</c> = clear (revert to
/// Cocoar default), other = replace. <see cref="PrimaryColor"/> is
/// validated against a strict CSS color-token regex on write.</summary>
