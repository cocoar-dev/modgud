...
public class SharedPostgresFixture : IAsyncLifetime
{
    ...
    /// </summary>
    public ModgudWebApplicationFactory Factory { get; private set; } = null!;
    ...
    public async ValueTask InitializeAsync()
    {
        ...
        [
            ...
            // ADR 0022: no cross-node relay, no drain in the test host (single process).
        ...
        Factory = new ModgudWebApplicationFactory(this);
    }
