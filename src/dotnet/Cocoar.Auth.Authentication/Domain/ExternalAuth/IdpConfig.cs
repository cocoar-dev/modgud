...
public class IdpConfig
{
    ...
    /// interpreted as a <b>patch</b> against the Cocoar.Auth user record — only
    ...
    /// Cocoar.Auth's control (for IdP-driven membership use SCIM, planned).
    /// </para>
    /// </summary>
    ...
    // ── Linking policy ───────────────────────────────────────────────
    /// <summary>Auto-create a new Cocoar.Auth user for an unseen subject.</summary>
    ...
    /// an existing Cocoar.Auth user, auto-link instead of refusing. Enable only for
