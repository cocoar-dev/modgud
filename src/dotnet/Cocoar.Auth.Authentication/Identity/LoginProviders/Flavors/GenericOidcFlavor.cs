...
namespace Cocoar.Auth.Authentication.Identity.LoginProviders.Flavors;
...
/// </summary>
public class GenericOidcFlavor : ILoginProviderFlavor
{
    public string Key => LoginProviderFlavor.GenericOidc;
    ...
    public string DefaultUserUpdateScript => """
        // Default user-property mapping. Returned object patches the Cocoar.Auth
