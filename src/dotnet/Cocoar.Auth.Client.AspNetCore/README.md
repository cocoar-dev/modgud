...
[Cocoar.Auth](https://github.com/cocoar-dev/Cocoar.Auth) identity provider.
...
Apache-2.0. See [LICENSE](https://github.com/cocoar-dev/Cocoar.Auth/blob/develop/LICENSE).
