...
/// <summary>
/// Marten / STJ wiring for the authorization slice. Hardcoded for Cocoar.Auth's
...
public static class MartenStoreOptionsExtensions
{
    ...
    /// <see cref="AddCocoarAuthAuthorizationPolymorphism"/> inside the consumer's
    ...
    /// </summary>
    public static void AddCocoarAuthAuthorizationPolymorphism(this JsonSerializerOptions opts)
    {
