...
/// <c>TerminalEnrollment</c> and linked to exactly one PositionPrincipal. Both
/// ids are set together or cleared together (enforced by
/// <c>ValidatePositionTerminalLinkInvariant</c>). Existing streams project
/// null — no data migration.
/// </summary>
public record OAuthApplicationPositionTerminalLinkChanged(
    Guid ApplicationId,
