...
/// <summary>
/// MG-FT-03 — pins <c>ValidateFunctionTerminalLinkInvariant</c> (plan §6.4):
...
/// </summary>
public class FunctionTerminalInvariantTests
{
    private static readonly string[] ValidGrants =
    [
        "urn:ietf:params:oauth:grant-type:device_code",
        "refresh_token",
        FunctionGrantTypes.StaffingSession,
    ];
    ...
    private static Error? Validate(
        ...
        => OAuthAdminMapping.ValidateFunctionTerminalLinkInvariant(
    ...
    public void The_staffing_grant_is_user_flow_so_an_sa_client_can_never_carry_it()
    {
        ...
        var err = OAuthAdminMapping.ValidateServiceAccountLinkInvariant(
            ["client_credentials", FunctionGrantTypes.StaffingSession],
    ...
    public void The_staffing_grant_maps_to_a_gt_permission()
        => Assert.Equal("gt:" + FunctionGrantTypes.StaffingSession,
            OAuthAdminMapping.MapGrantTypeToPermission(FunctionGrantTypes.StaffingSession));
}
