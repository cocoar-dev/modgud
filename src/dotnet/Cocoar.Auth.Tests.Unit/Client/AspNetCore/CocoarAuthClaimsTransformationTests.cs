...
public class CocoarAuthClaimsTransformationTests
{
    ...
    private static CocoarAuthClaimsTransformation NewSubject(string audience = Audience) =>
        new(Options.Create(new CocoarAuthOptions { Audience = audience }));
    ...
    private static Claim ResourceAccessClaim(string raw) =>
        new(CocoarAuthClaimsTransformation.ResourceAccessClaimType, raw);
    ...
    public class ShortCircuits
    {
        ...
        public async Task Anonymous_principal_is_left_untouched()
        {
            ...
            Assert.Empty(transformed.FindAll(ClaimTypes.Role));
            Assert.Empty(transformed.FindAll(CocoarAuthClaimsTransformation.PermissionClaimType));
        }
    ...
    public class Configuration
    {
        ...
        public void Constructor_throws_when_Audience_is_missing()
        {
            var ex = Assert.Throws<InvalidOperationException>(() =>
                new CocoarAuthClaimsTransformation(Options.Create(new CocoarAuthOptions { Audience = "" })));
