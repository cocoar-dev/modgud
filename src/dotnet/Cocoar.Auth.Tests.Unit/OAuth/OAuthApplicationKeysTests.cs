...
public class OAuthApplicationKeysTests
{
    public class SettingKeys
    {
        ...
        public void AccessTokenType_value_is_pinned() =>
            Assert.Equal("cocoar:access_token_type", OAuthApplicationSettingKeys.AccessTokenType);

        [Fact]
        public void RefreshTokenUsage_value_is_pinned() =>
            Assert.Equal("cocoar:refresh_token_usage", OAuthApplicationSettingKeys.RefreshTokenUsage);

        [Fact]
        public void IdentityTokenLifetime_value_is_pinned() =>
            Assert.Equal("cocoar:identity_token_lifetime", OAuthApplicationSettingKeys.IdentityTokenLifetime);

        [Fact]
        public void AccessTokenLifetime_value_is_pinned() =>
            Assert.Equal("cocoar:access_token_lifetime", OAuthApplicationSettingKeys.AccessTokenLifetime);

        [Fact]
        public void AuthorizationCodeLifetime_value_is_pinned() =>
            Assert.Equal("cocoar:authorization_code_lifetime", OAuthApplicationSettingKeys.AuthorizationCodeLifetime);

        [Fact]
        public void AbsoluteRefreshTokenLifetime_value_is_pinned() =>
            Assert.Equal("cocoar:absolute_refresh_token_lifetime", OAuthApplicationSettingKeys.AbsoluteRefreshTokenLifetime);

        [Fact]
        public void SlidingRefreshTokenLifetime_value_is_pinned() =>
            Assert.Equal("cocoar:sliding_refresh_token_lifetime", OAuthApplicationSettingKeys.SlidingRefreshTokenLifetime);

        [Fact]
        public void ClientClaimsPrefix_value_is_pinned() =>
            Assert.Equal("cocoar:client_claims_prefix", OAuthApplicationSettingKeys.ClientClaimsPrefix);

        [Fact]
        public void All_setting_keys_use_the_cocoar_prefix()
        {
            // Cocoar's custom keys live under the "cocoar:" namespace so they cannot collide
    ...
    public class PropertyKeys
    {
        ...
        public void Enabled_value_is_pinned() =>
            Assert.Equal("cocoar:enabled", OAuthApplicationPropertyKeys.Enabled);

        [Fact]
        public void AllowAccessTokensViaBrowser_value_is_pinned() =>
            Assert.Equal("cocoar:allow_access_tokens_via_browser", OAuthApplicationPropertyKeys.AllowAccessTokensViaBrowser);

        [Fact]
        public void RequireClientSecret_value_is_pinned() =>
            Assert.Equal("cocoar:require_client_secret", OAuthApplicationPropertyKeys.RequireClientSecret);

        [Fact]
        public void EnableLocalLogin_value_is_pinned() =>
            Assert.Equal("cocoar:enable_local_login", OAuthApplicationPropertyKeys.EnableLocalLogin);

        [Fact]
        public void RequireConsent_value_is_pinned() =>
            Assert.Equal("cocoar:require_consent", OAuthApplicationPropertyKeys.RequireConsent);

        [Fact]
        public void AllowRememberConsent_value_is_pinned() =>
            Assert.Equal("cocoar:allow_remember_consent", OAuthApplicationPropertyKeys.AllowRememberConsent);

        [Fact]
        public void AllowedCorsOrigins_value_is_pinned() =>
            Assert.Equal("cocoar:allowed_cors_origins", OAuthApplicationPropertyKeys.AllowedCorsOrigins);

        [Fact]
        public void AlwaysSendClientClaims_value_is_pinned() =>
            Assert.Equal("cocoar:always_send_client_claims", OAuthApplicationPropertyKeys.AlwaysSendClientClaims);

        [Fact]
        public void UpdateAccessTokenClaimsOnRefresh_value_is_pinned() =>
            Assert.Equal("cocoar:update_access_token_claims_on_refresh", OAuthApplicationPropertyKeys.UpdateAccessTokenClaimsOnRefresh);

        [Fact]
        public void ClientClaims_value_is_pinned() =>
            Assert.Equal("cocoar:client_claims", OAuthApplicationPropertyKeys.ClientClaims);

        [Fact]
        public void Roles_value_is_pinned() =>
            Assert.Equal("cocoar:roles", OAuthApplicationPropertyKeys.Roles);

        [Fact]
        public void All_property_keys_use_the_cocoar_prefix()
        {
            var keys = new[]
            {
