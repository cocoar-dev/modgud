...
/// for both public AND confidential clients. Cocoar.Auth's
...
public class PkceRequirementPinTests
{
    ...
    private sealed class TestOpenIddictSettings : Cocoar.Auth.Infrastructure.OpenIddict.IOpenIddictSettings
    {
