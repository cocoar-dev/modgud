...
namespace Modgud.Api.Features.Distribution;

/// <summary>
/// Server-to-server distribution API — historically the home for resource
/// servers calling Modgud on behalf of an authenticated user.
///
                ...
                IPermissionService permissionService) =>
            {
                ...
                if (rs is null)
                {
                    httpContext.Response.Headers.WWWAuthenticate =
                        "ModgudRS error=\"invalid_client\", error_description=\"Resource-server credentials are required on this endpoint.\"";
