...
endpoint, with the bearer token's audience matching their registered
OAuth API Audience. The linked App may have a different slug. No
special CORS — server-to-server.
