      ...
      '/integrate/': [
        {
          ...
          items: [
            ...
            { text: 'Application change feed', link: '/integrate/application-change-feed' },
      ...
      '/decisions/': [
        {
          ...
          items: [
            { text: 'Overview & number map', link: '/decisions/' },
            { text: '0001 · OAuth / MCP client registration', link: '/decisions/0001-oauth-mcp-client-registration' },
            { text: '0002 · Public origin derived (superseded)', link: '/decisions/0002-public-origin-derived' },
            { text: '0003 · Hybrid persistence', link: '/decisions/0003-persistence-hybrid-event-sourcing-and-documents' },
            { text: '0004 · Database per realm', link: '/decisions/0004-tenancy-database-per-realm' },
            { text: '0005 · Permission model', link: '/decisions/0005-permission-model-catalog-rbac' },
            { text: '0006 · Identity hub, not proxy', link: '/decisions/0006-identity-hub-not-federation-proxy' },
            { text: '0007 · Access-token format', link: '/decisions/0007-access-token-format' },
            { text: '0008 · CIMD', link: '/decisions/0008-cimd-client-id-metadata-documents' },
            { text: '0009 · Per-client WebAuthn RP-ID', link: '/decisions/0009-per-client-webauthn-rp-id' },
            { text: '0010 · Native cookieless grants', link: '/decisions/0010-native-cookieless-token-grants' },
            { text: '0011 · Application tier', link: '/decisions/0011-application-tier-origin-facet' },
            { text: '0012 · Invite-code self-registration', link: '/decisions/0012-invite-code-self-registration' },
            { text: '0013 · PageBuilder page variants', link: '/decisions/0013-pagebuilder-page-variants' },
            { text: '0014 · Customization core first', link: '/decisions/0014-customization-core-before-page-builder' },
            { text: '0015 · Positions & shared terminals', link: '/decisions/0015-positions-terminals-staffing-shared-device-model' },
            { text: '0016 · Position policy & binding', link: '/decisions/0016-position-policy-binding-control-plane' },
            { text: '0017 · Staged configuration', link: '/decisions/0017-staged-configuration-draft-mode' },
            { text: '0018 · Registration before proof', link: '/decisions/0018-registration-before-proof' },
            { text: '0019 · Caller context & rate limits', link: '/decisions/0019-caller-context-and-rate-limiting' },
            { text: '0020 · Device-aware login throttling', link: '/decisions/0020-device-aware-login-throttling' },
