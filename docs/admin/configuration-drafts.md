...
- Entities the manifest does not model (terminal slots and terminal-managed clients, the position grant lifecycle) are managed live in their own admin surfaces. Service accounts export/import with their credentials; the account's delete stays live.
